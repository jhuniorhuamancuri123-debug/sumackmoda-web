    ...
    <div style={{ paddingTop: '80px', minHeight: '100vh' }}>
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '3rem 1.5rem' }}>
        ...
        <Section titulo="Cambios — plazo máximo 4 días">
          Solo se aceptan cambios dentro de los <strong>4 días calendario</strong> desde la recepción del pedido. Pasado este plazo no se aceptan cambios bajo ninguna circunstancia.
        </Section>
        <Section titulo="Condiciones para cambio">
          La prenda debe estar sin uso, sin lavar, sin manchas, sin olores y con todas sus etiquetas originales. Prendas que presenten señales de uso, daño, alteración o lavado no serán aceptadas. SUMACK se reserva el derecho de rechazar cualquier cambio que no cumpla estas condiciones.
        </Section>
        ...
        <Section titulo="Envíos">
          Los tiempos de entrega son referenciales y dependen de la agencia de transporte. SUMACK no se responsabiliza por retrasos, extravíos o daños ocurridos durante el transporte una vez entregado el paquete a la agencia.
        </Section>
