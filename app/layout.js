    ...
    <header className="navbar">
      <div className="navbar-inner">
        ...
        <div className="navbar-icons">
          ...
          <a href="/cuenta" className="icon-btn" aria-label="Mi cuenta">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
              <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>
            </svg>
          </a>
          <button className="icon-btn carrito-btn" aria-label="Carrito">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
              <path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/>
            </svg>
            <span className="carrito-count" id="carrito-count">0</span>
          </button>
        </div>
      </div>
    </header>
  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-bottom">
        <p>© {new Date().getFullYear()} SUMACK. Todos los derechos reservados.</p>
        <p>Lima, Perú</p>
      </div>
    </footer>
  );
